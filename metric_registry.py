...
VMAT_METRIC_SPECS = (
    ...
    MetricSpec("mcsv", "MCSv", "10.1118/1.4810969", dual_mlc=True, aliases=("modulation_complexity_score",), description="Overall aperture modulation score combining area and leaf sequence variability."),
