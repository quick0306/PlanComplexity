...
VMAT_METRIC_SPECS = (
    MetricSpec("ethos_sas10", "Varian Dual-layer SAS10", description="Varian Ethos/Halcyon dual-layer MLC v2: pooled open-slot counts at positive-center-MU control points with gap > 0.5 mm; fraction, not percent. 12-plan display agreement (RP/PDF labels may differ); see docs/ethos_report_profile.md."),
    MetricSpec("ethos_one_minus_mcs", "Varian Dual-layer 1-MCS", description="Varian Ethos/Halcyon dual-layer MLC v2: centered-MU mean of CP AAV*LSV, complemented; physical open-slot adjacency. 12-plan display agreement (RP/PDF labels may differ); distinct from MCSv/MCS5."),
    MetricSpec("ethos_penumbra_ratio", "Varian Dual-layer Penumbra Ratio", description="Varian Ethos/Halcyon dual-layer MLC v2: finite tip/side strip union with 2.8/2.3 mm distances; fraction, not percent. 12-plan display agreement (RP/PDF labels may differ); distinct from EAM."),
