...
def build_comparator_matrix() -> dict[str, object]:
        ...
        metric_rows.append(
            {
                ...
                "mapping_provenance": "legacy-unverified" if mapping else "none",
    ...
    return {
        "summary": {
            ...
            "verified_external_samples": 0,
            "scope": "Mapping inventory only; legacy samples have no external provenance. See external_benchmarks.json for actual captures.",
        },
